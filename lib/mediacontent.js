...
(function () {
  ...
  WebinosMediaContentService.prototype.getLocalFolders = function (params, successCB, errorCB) {
    ...
    if (os.type().toLowerCase() === "linux") {
      ...
      music = path.resolve('/Users/felix/Desktop/Media/', 'Music');
      video = path.resolve('/Users/felix/Desktop/Media/', 'Movies');
      pictures = path.resolve('/Users/felix/Desktop/Media/', 'Pictures');
  ...
  WebinosMediaContentService.prototype.getLink = function (params, successCallback, errorCallback) {
    var self = this;
    self.findItem(params, function (item) {
      var ref = uuid.v4();
